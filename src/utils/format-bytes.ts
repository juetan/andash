// source: https://jsr.io/@std/fmt/1.0.3/bytes.ts
 ...
 *
 * @see https://jsr.io/@std/fmt/1.0.3/bytes.ts
 * @example
 * ```ts
 * formatBytes(1337)                   // "1.34 kB"
 * formatBytes(100)                    // "100 B"
 * formatBytes(1337, { bits: true })   // "1.34 kbit"
 * formatBytes(42, { signed: true })   // "+42 B"
 * formatBytes(1337, { locale: "de" }) // "1,34 kB"
 * ```
 */
export function formatBytes(num: number, options: FormatOptions = {}): string {
...
function getLocaleOptions({ maximumFractionDigits, minimumFractionDigits }: FormatOptions): LocaleOptions | undefined {
